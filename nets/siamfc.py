...
class BaselineEmbeddingNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.fully_conv = nn.Sequential(nn.Conv2d(1, 96, kernel_size=11,
                                                  stride=2, bias=True),
                                        nn.BatchNorm2d(96),
                                        nn.ReLU(),
...
class VGG11EmbeddingNet_5c(nn.Module):
    ...
    def __init__(self):
        ...
        self.fully_conv = nn.Sequential(nn.Conv2d(1, 64, kernel_size=3,
                                                  stride=1, bias=True),
                                        nn.BatchNorm2d(64),
                                        nn.Tanh(),
...
class SiameseNet(nn.Module):
    ...
    def __init__(self, embedding_net=None, upscale=False, corr_map_size=1, stride=4):
    ...
    def match_corr(self, embed_ref, embed_srch):
        ...
        match_map = match_map.squeeze(1).squeeze(1)
        return match_map
