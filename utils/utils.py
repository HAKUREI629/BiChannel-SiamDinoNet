...
def load_dataset(dataset_path, train_own_data, train_ratio, feature):
    types       = 0
    train_path  = os.path.join(dataset_path, feature)
    lines       = []
    labels      = []
    ...
    if train_own_data:
        for character in os.listdir(train_path + '/train'):
            character_path = os.path.join(train_path + '/train', character)
        ...
        types = 0
        for character in os.listdir(train_path + '/valid'):
            character_path = os.path.join(train_path + '/valid', character)
            for image in os.listdir(character_path):
...
def load_datasetv4(dataset_path, train_own_data, train_ratio, feature):
    types       = 0
    train_path  = os.path.join(dataset_path, feature)
    lines       = []
    labels      = []
